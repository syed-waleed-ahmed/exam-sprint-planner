...
export default function TopBar({ onToggleNav, onOpenAddExam, onOpenTimer, activeTopicName, isOnline, syncMeta }) {
  return (
    <header className="fixed top-0 right-0 left-0 z-20 border-b border-white/10 bg-surface/70 px-4 py-3 backdrop-blur-xl md:left-72 md:px-6">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <button className="btn-ghost px-2 py-2 text-muted md:hidden" onClick={onToggleNav}>
